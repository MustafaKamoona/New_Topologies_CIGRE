...
- **Topologies:**
- Topology-1: End-of-feeder AC/DC links
- Topology-2: Mixed wiring (single-phase AC + two-wire DC)
- Topology-3: Fully hybrid AC/DC network (parallel DC grid)
...
- **Operating scenarios:**
- Load-1: AC overloading
- Load-2: High DC penetration
...
- cigre_eu_lv_acdc_link_ini_No_Droop_T1_L1.ipynb: Topology-1, Load-1, without droop.
- cigre_eu_lv_acdc_link_ini_Droop_T1_L1.ipynb: Topology-1, Load-1, with droop.
- cigre_eu_lv_acdc_link_ini_No_Droop_T1_L2.ipynb: Topology-1, Load-2, without droop.
- cigre_eu_lv_acdc_link_ini_Droop_T1_L2.ipynb: Topology-1, Load-2, with droop.
...
- cigre_eu_lv_acdc_4w_ini_No_Droop_T2_L2.ipynb: Topology-2, Load-2, without droop
- cigre_eu_lv_acdc_4w_ini_Droop_T2_L2.ipynb: Topology-2, Load-2, with droop
...
- cigre_eu_lv_acdc_6w_ini_No_Droop_T3_L1.ipynb: Topology-3, Load-1, without droop
- cigre_eu_lv_acdc_6w_ini_Droop_T3_L1.ipynb: Topology-3, Load-1, with droop
- cigre_eu_lv_acdc_6w_ini_No_Droop_T3_L2.ipynb: Topology-3, Load-2, without droop
- cigre_eu_lv_acdc_6w_ini_Droop_T3_L2.ipynb: Topology-3, Load-2, with droop
...
# Notes
- Bus voltages and feeder currents are saved in each run notebook for post-processing.
- Builder notebooks must be executed before running any topology.
- Load cases: - **Case 1 → Load-1** AND - **Case 3 → Load-2**
